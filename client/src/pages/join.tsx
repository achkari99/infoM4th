...
export default function Join() {
  ...
  function onSubmit(values: z.infer<typeof formSchema>) {
    toast({
      title: "Welcome to InfoM4th!",
      description: "We'll be in touch soon. Check your email for next steps.",
    });
    form.reset();
  }
      ...
      <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            >
              <p className="text-lg font-bold leading-relaxed">
                No experience necessary. Beginners, intermediates, and advanced students all have a place here. We believe in learning together.
              </p>
            </motion.div>
          </motion.div>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Input 
                          ...
                          {...field} 
                          className="border-2 border-black h-12 text-base focus-visible:ring-offset-0 focus-visible:ring-4 focus-visible:ring-primary rounded-none bg-gray-50" 
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
                    ...
                    <FormItem>
                      ...
                      <FormControl>
                        <Textarea 
                          ...
                          {...field} 
                          className="border-2 border-black min-h-[100px] text-base focus-visible:ring-offset-0 focus-visible:ring-4 focus-visible:ring-primary rounded-none bg-gray-50 resize-none" 
                        />
                      </FormControl>
                      <FormMessage />
                    </FormItem>
        ...
        >
          ...
          <p className="text-xl md:text-2xl">
            Every semester, we welcome new members and grow stronger. You're joining not just a club, but a community of thinkers and builders.
          </p>
        </motion.div>
      </div>
    </div>
