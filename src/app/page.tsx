...
export default function HomePage() {
  const pillars = [
    {
      ...
      title: "Build",
      description:
        "Code, solve, and ship real projects that matter. From web apps to algorithms, create with purpose.",
    },
    {
      icon: Brain,
      title: "Think",
      description:
        "Dive deep into algorithms, math, and systems thinking. Understand the why behind the what.",
    },
    {
      icon: Zap,
      title: "Connect",
      description:
        "Network with ambitious peers and industry professionals. Grow together, learn faster.",
    },
  ];
  ...
  const testimonials = [
    {
      text:
        "InfoM4th helped me transition from pure math to full-stack development. The library is incredible.",
      author: "Alex T.",
      role: "2nd Year CS Major",
    },
    {
      text:
        "The workshop quality is insane. You won't find this level of depth in a regular club.",
      author: "Jordan M.",
      role: "1st Year CS & Math Double Major",
    },
    {
      text:
        "Finally a space where I could ask deep theoretical questions AND ship code.",
      author: "Casey S.",
    ...
    <div className="min-h-screen bg-background pt-32 pb-20 overflow-x-hidden">
      ...
      <section className="relative min-h-[70vh] flex flex-col justify-center items-center px-6 mb-20">
        ...
        <div className="relative z-10 text-center">
          ...
          >
            A community for Computer Science and Mathematics students{" "}
            <span className="font-bold">building, learning, and solving</span>{" "}
          ...
          >
            <Link
              href="/join"
              className="inline-block px-8 py-4 bg-primary text-white text-xl font-bold uppercase border-2 border-transparent hover:border-primary hover:bg-transparent hover:text-primary transition-all neo-shadow hover:neo-shadow-hover cursor-pointer"
            >
              Join Us
            </Link>
            <Link
              href="/library"
              className="inline-block px-8 py-4 bg-white text-black text-xl font-bold uppercase border-2 border-black hover:bg-black hover:text-white transition-all neo-shadow hover:neo-shadow-hover cursor-pointer"
            >
              Explore Library
            </Link>
          </motion.div>
      ...
      {/* Testimonials */}
      <section className="px-6 md:px-12 max-w-7xl mx-auto mb-32">
        <h2 className="text-6xl md:text-7xl font-display font-black uppercase mb-12 text-center">
          What Members Say
        </h2>
      ...
      <section className="bg-primary text-white py-24 px-6 relative overflow-hidden">
        <div className="max-w-5xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl mb-12 max-w-2xl mx-auto">
            Access exclusive workshops, recorded sessions, and curated learning
            paths built by and for ambitious students.
          </p>
          <Link
            href="/library"
            className="inline-block px-10 py-5 bg-white text-primary text-2xl font-bold uppercase border-2 border-white hover:bg-transparent hover:text-white transition-all neo-shadow hover:neo-shadow-hover cursor-pointer"
          >
            Browse Library
          </Link>
        </div>
      ...
      <section className="px-6 md:px-12 max-w-7xl mx-auto py-20">
        ...
        >
          <h2 className="text-5xl md:text-6xl font-display font-black uppercase mb-6 text-white">
            Upcoming Events
          </h2>
          <p className="text-xl text-white opacity-90 mb-8 max-w-2xl">
            From algorithm sprints to industry talks and hackathons. Check out
            our event calendar and join us!
          </p>
          <Link
            href="/events"
            className="inline-flex items-center gap-3 px-8 py-4 bg-white text-accent font-bold uppercase border-2 border-white hover:bg-transparent hover:text-white transition-all neo-shadow hover:neo-shadow-hover cursor-pointer"
          >
