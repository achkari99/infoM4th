...
export default function AdminUsersPage() {
  ...
  if (sessionLoading || isLoading) {
    return (
      <div className="p-8 max-w-7xl mx-auto text-zinc-500 uppercase tracking-[0.3em] text-xs">Loading users</div>
    );
  }
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto space-y-8">
      <div className="flex flex-col gap-4">
        ...
        <div className="flex items-center justify-between gap-4">
          <div>
            ...
            <p className="text-zinc-500">Profiles synchronized from Supabase auth.</p>
          </div>
      ...
      <div className="flex items-center gap-4 bg-zinc-950/80 px-3 py-2 rounded-full border border-zinc-800 max-w-md">
      ...
      <div className="grid gap-4">
        {filteredProfiles.length === 0 ? (
          <div className="border border-zinc-800 bg-zinc-900/60 text-zinc-400 p-6 rounded-2xl">
          ...
          filteredProfiles.map((profile) => (
            <div
              key={profile.id}
              className="border border-zinc-800 bg-zinc-900/60 p-6 rounded-2xl flex flex-col md:flex-row md:items-center md:justify-between gap-6"
            >
              ...
              <div className="flex items-center gap-4 text-xs uppercase tracking-[0.2em] text-zinc-500">
                ...
                <div className="flex items-center gap-2">
                  <button
                    className="text-xs uppercase tracking-[0.2em] text-primary hover:text-white transition-colors disabled:opacity-40"
